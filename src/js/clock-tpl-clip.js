...
'<div class="hold">'+
    '<div class="pie pie1" style="<%= data.leftStyle %>"></div>'+
'</div>'+
'<div class="hold">'+
    '<div class="pie pie2" style="<%= data.rightStyle %>"></div>'+
'</div>'+
'<div class="bg"> </div>'+
...
var rotate = function(remainTime, totalTime){
    var an = angle(totalTime - remainTime, totalTime);
    var data = {};
    ...
    if(!totalTime){
        ...
        data.leftStyle = '-webkit-transform:rotate(180deg);';
        data.rightStyle = '-webkit-transform:rotate('+an+'deg);transform:rotate('+an+'deg);background-color:#d13c36;';
    }
